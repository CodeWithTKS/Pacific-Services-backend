const aepsmoneytransferService = require('../services/aepsmoneytransferService');

// Add a new money transfer
const addMoneyTransfer = async (req, res) => {
    try {
        const transferData = req.body;
        const result = await aepsmoneytransferService.addMoneyTransfer(transferData);
...
const updateMoneyTransfer = async (req, res) => {
    try {
        ...
        const transferData = req.body;
        const result = await aepsmoneytransferService.updateMoneyTransfer(transferId, transferData);
...
const deleteMoneyTransfer = async (req, res) => {
    try {
        const transferId = req.params.id;
        const result = await aepsmoneytransferService.deleteMoneyTransfer(transferId);
...
const getMoneyTransferById = async (req, res) => {
    try {
        const transferId = req.params.id;
        const result = await aepsmoneytransferService.getMoneyTransferById(transferId);
...
const updateTransactionNo = async (req, res) => {
    try {
        ...
        const result = await aepsmoneytransferService.updateTransactionNo
...
const getAllMoneyTransfers = async (req, res) => {
    try {
        ...
        const result = await aepsmoneytransferService.getAllMoneyTransfers(fromDate, toDate, portalId);
...
const getTotalCashController = async (req, res) => {
    try {
        const [totalWithTransaction, overallTotal] = await Promise.all([
            aepsmoneytransferService.getTotalCashWithTransactionNo(),
            aepsmoneytransferService.getOverallTotalCash()
        ]);
